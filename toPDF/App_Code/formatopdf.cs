...
public class formatopdf
{
    ...
    {
        string CadenaGral = AppDomain.CurrentDomain.BaseDirectory.ToString() + "images\\banner.png";
    ...
    public static void IngresaFondoAzul(string Texto, int union, int pri, int seg, int ter)
    {
        Cell c0 = new Cell();
        c0.BorderWidth = 0;
        //c0.BorderWidthTop = 1;
    ...
    public static void CierradocHorizontal(string nombredoc, string NUsuario, string Direccion)
    {
        ...
        HeaderFooter footer = new HeaderFooter(new Phrase("Fuente: Conagua\n Fecha: " + DateTime.Now.ToShortDateString() + "\nPag: ", font), true);
        footer.Border = Rectangle.NO_BORDER;
        Doc.Footer = footer;
